...
public class CurrencyAdapter extends  RecyclerView.Adapter<CurrencyAdapter.MyHolder> {
    ...
    private List<CurrencyResult.Posts> list;
    private LayoutInflater inflater;

    public CurrencyAdapter(Context context, List<CurrencyResult.Posts> list){
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CurrencyAdapter.MyHolder myHolder = new CurrencyAdapter.MyHolder(view);
        return myHolder;
    }
